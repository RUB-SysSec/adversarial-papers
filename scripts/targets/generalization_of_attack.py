...
models_dir = MODELS_BASE_DIR / "usenix_20"
targets_dir = TARGETS_BASE_DIR
submissions_dir_sources = SUBMISSIONS_BASE_DIR  / "usenix_20" / "arxiv-sources" / "submissions_latexpanded"
submissions_dir_compiled = SUBMISSIONS_BASE_DIR / "usenix_20" / "pdf_compiled"
...
for no_select, no_reject in [(1, 0), (0, 1), (1, 1)]:
    ...
    for model in tqdm(models, ncols=80):
        ...
        for submission_pdf in sorted(submissions_dir_compiled.glob('*.pdf')):
            ...
            if submission_pdf.stem in ['1911.05673', '1908.02444']:
                continue
 ...
 # save targets
targets_file = targets_dir.joinpath(f'generalization_of_attack.json')
